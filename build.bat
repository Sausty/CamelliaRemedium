...
cl %CommonCompilerFlags% ../code/camellia_win32.c ../code/camellia_math.c ../code/camellia_renderer_d3d12.c ../code/camellia_dsound.c -Fmcamelia_win32.map /link %CommonLinkerFlags%
POPD
